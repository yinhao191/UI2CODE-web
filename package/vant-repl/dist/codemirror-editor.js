  ...
  (function (module, exports) {
    ...
    (function (global, factory) {
      ...
      function measureCharInner(cm, prepared, ch, bias) {
        ...
        var result = {
          left:
            (collapse == "right" ? rect.right : rect.left) - prepared.rect.left,
          right:
            (collapse == "left" ? rect.left : rect.right) - prepared.rect.left,
          top: top,
          bottom: bot,
        };
      ...
      function endOperation_R2(op) {
        ...
        if (display.maxLineChanged && !cm.options.lineWrapping) {
          op.adjustWidthTo =
            measureChar(cm, display.maxLine, display.maxLine.text.length).left +
            3;
      ...
      function restoreSelection(snapshot) {
        if (
          !snapshot ||
          !snapshot.activeElt ||
          snapshot.activeElt == activeElt(rootNode(snapshot.activeElt))
        ) {
          return;
        }
        ...
        CodeMirror.prototype = {
            ...
            this.extendSelectionsBy(function (range) {
              if (
                ...
                return findPosH(
                  ...
                  dir,
                  unit,
                  this$1$1.options.rtlMoveVisually,
                );
              } else {
          ...
          moveV: methodOp(function (dir, unit) {
            ...
            doc.extendSelectionsBy(function (range) {
              ...
              if (unit == "page" && range == doc.sel.primary()) {
                addToScrollTop(
                  this$1$1,
                  charCoords(this$1$1, pos, "div").top - headPos.top,
                );
              }
              return pos;
            }, sel_move);
          ...
          getScrollInfo: function () {
            ...
            return {
              ...
              width:
                scroller.scrollWidth - scrollGap(this) - this.display.barWidth,
      ...
      ContentEditableInput.prototype.focus = function () {
        if (this.cm.options.readOnly != "nocursor") {
          if (
            ...
            activeElt(rootNode(this.div)) != this.div
          ) {
      ...
      TextareaInput.prototype.focus = function () {
        if (
          ...
          (!mobile || activeElt(rootNode(this.textarea)) != this.textarea)
        ) {
          try {
            this.textarea.focus();
        ...
        function maybePopContext(state, nextTagName) {
          ...
          while (true) {
            ...
            if (
              ...
              !config.contextGrabbers[lower(parentTagName)].hasOwnProperty(
                lower(nextTagName),
              )
            ) {
              return;
            ...
            if (tagAfter && tagAfter[1]) {
              ...
              while (context) {
                if (context.tagName == tagAfter[2]) {
                  ...
                  config.implicitlyClosed.hasOwnProperty(lower(context.tagName))
                ) {
                  context = context.prev;
                } else {
                  break;
  ...
  (function (module, exports) {
    ...
    (function (mod) {
      ...
      function autoCloseGT(cm) {
        ...
        for (var i = 0; i < ranges.length; i++) {
          ...
          var inner = CodeMirror.innerMode(cm.getMode(), tok.state),
            state = inner.state;
          var tagInfo =
            inner.mode.xmlCurrentTag && inner.mode.xmlCurrentTag(state);
      ...
      function autoCloseCurrent(cm, typingSlash) {
        ...
        var opt = cm.getOption("autoCloseTags");
        var dontIndentOnAutoClose =
          typeof opt == "object" && opt.dontIndentOnSlash;
        for (var i = 0; i < ranges.length; i++) {
          if (!ranges[i].empty()) return CodeMirror.Pass;
          var pos = ranges[i].head,
            tok = cm.getTokenAt(pos);
          ...
          var replacement,
            mixed =
              inner.mode.name != "xml" && cm.getMode().name == "htmlmixed";
          if (mixed && inner.mode.name == "javascript") {
            ...
            if (
              !context ||
              (context.length && closingTagExists(cm, context, top, pos))
            )
              return CodeMirror.Pass;
  ...
  (function (module, exports) {
    ...
    (function (mod) {
      ...
      function updateFoldInfo(cm, from, to) {
        ...
        var clsOpen =
          typeof opts.indicatorOpen == "string" &&
          ...
          function findRange(found) {
            ...
            outer: for (var i = line; i <= lastLine; ++i) {
              ...
              for (;;) {
                ...
                if (
                  cm.getTokenTypeAt(CodeMirror.Pos(i, pos + 1)) ==
                  found.tokenType
                ) {
...
var indentFold = { exports: {} };

var hasRequiredIndentFold;
...
function requireIndentFold() {
  ...
  return indentFold.exports;
}

requireIndentFold();

var commentFold = { exports: {} };

var hasRequiredCommentFold;
    ...
    (function (mod) {
      ...
      function searchRegexpBackward(doc, regexp, start) {
        ...
        for (
          ...
          var string = doc.getLine(line);
          var match = lastMatchIn(
            string,
            regexp,
            ch < 0 ? 0 : string.length - ch,
          );
          if (match)
            return {
              from: Pos(line, match.index),
      ...
      SearchCursor.prototype = {
        ...
        find: function (reverse) {
          ...
          this.afterEmptyMatch =
            result && CodeMirror.cmpPos(result.from, result.to) == 0;
  ...
  (function (module, exports) {
    ...
    (function (mod) {
      ...
      cmds.goToBracket = function (cm) {
        cm.extendSelectionsBy(function (range) {
          ...
          var prev = cm.scanForBracket(
            ...
            -1,
            puncType(
              cm.getTokenTypeAt(Pos(range.head.line, range.head.ch + 1)),
            ),
          );
      ...
      cmds.joinLines = function (cm) {
        ...
        cm.operation(function () {
          ...
          for (var i = 0; i < joined.length; i++) {
            var obj = joined[i];
            var anchor =
                obj.anchor && Pos(obj.anchor.line - offset, obj.anchor.ch),
              head;
      ...
      cmds.toggleBookmark = function (cm) {
        var ranges = cm.listSelections();
        var marks =
          cm.state.sublimeBookmarks || (cm.state.sublimeBookmarks = []);
        for (var i = 0; i < ranges.length; i++) {
          var from = ranges[i].from(),
            to = ranges[i].to();
      ...
      return (
        ...
        createElementBlock(
          "div",
          {
            ...
            class: "editor",
            onKeydown: [
              withKeys(withModifiers(emitChangeEvent, ["ctrl", "prevent"]), [
                "s",
              ]),
              withKeys(withModifiers(emitChangeEvent, ["meta", "prevent"]), [
                "s",
              ]),
            ],
          },
