...
export declare const Preview: DefineComponent<
  ...
  string,
  PublicProps,
  Readonly<__VLS_Props_2> & Readonly<{}>,
  {},
  {},
  {},
  {},
  ...
  false,
  {
    sandbox: CreateComponentPublicInstanceWithMixins<
...
export declare const Repl: DefineComponent<
  ...
  false,
  {
    output: CreateComponentPublicInstanceWithMixins<
      Readonly<{
        ...
        Readonly<{}>,
      {
        reload: () => void;
        previewRef: Readonly<
          ShallowRef<CreateComponentPublicInstanceWithMixins<
            Readonly<{
              show: boolean;
              ssr: boolean;
            }> &
      ...
      string,
      {
        preview: CreateComponentPublicInstanceWithMixins<
          Readonly<{
            show: boolean;
            ssr: boolean;
          }> &
...
export declare const Sandbox: DefineComponent<
  SandboxProps,
  {
...
export declare type Store = Pick<
  ReplStore,
  | "files"
  | "activeFile"
  | "mainFile"
...
export declare function useStore(
  {
    files,
    activeFilename, // set later
    mainFile,
    template,
    builtinImportMap, // set later
    errors,
    showOutput,
    outputMode,
    sfcOptions,
